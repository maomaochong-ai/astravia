...
// 共享 chunk，而 Electron 以单文件加载 preload、无法解析同级 chunk，导致 window.astravia 整体加载失败。
const RELOAD_HOTKEY = "astravia:quickpanel:reload-hotkey";
const RUN_PROMPT = "astravia:quickpanel:run-prompt";
