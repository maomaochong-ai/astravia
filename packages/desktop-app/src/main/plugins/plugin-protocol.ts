...
`);
	...
	if (moduleName === "ui" || moduleName === "astravia-ui") {
		// Legacy ESM / explicit astravia-host:// imports. MF plugins normally resolve
		// @astravia/ui via share scope; keep export list in sync with packages/ui/src/index.ts.
		return moduleResponse(`
