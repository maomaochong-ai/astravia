...
export const NOTIFICATION_SET_FOREGROUND_CHANNEL = "astravia:notification:set-foreground-session";
/** 主进程→渲染端：用户点击系统通知后下发的路由意图。 */
export const NOTIFICATION_NAVIGATE_CHANNEL = "astravia:notification:navigate";
