import type { ThemeColorOverrides } from "@astravia/theme-sdk/appearance";
...
export const MODE_STORAGE_KEY = "astravia-theme";
export const THEME_STORAGE_KEY = "astravia-color-theme";
