...
const CATALOG = [
	...
	{
		tabId: "database",
		contextLabelKey: "aiAssist.context.database",
		defaultIntentKey: "aiAssist.defaultIntent.database",
		placeholderKey: "aiAssist.placeholder.database",
		exampleKeys: [
			WHAT_CAN_YOU_CONFIGURE,
			"aiAssist.examples.database.add",
			"aiAssist.examples.database.test",
			"aiAssist.examples.database.remove",
		],
	},
	{
		tabId: "automation",
	...
	},
	{
		...
		contextLabelKey: "aiAssist.context.databaseWorkbench",
		defaultIntentKey: "aiAssist.defaultIntent.databaseWorkbench",
		placeholderKey: "aiAssist.placeholder.databaseWorkbench",
		exampleKeys: [
			WHAT_CAN_YOU_CONFIGURE,
			"aiAssist.examples.databaseWorkbench.analyze",
			"aiAssist.examples.databaseWorkbench.query",
			"aiAssist.examples.databaseWorkbench.quality",
		],
	},
