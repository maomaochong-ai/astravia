...
import { AppshotSettingsView as ThemeAppshotSettingsView } from "@astravia/theme-ui/settings";
import { Trans } from "react-i18next";
import { SETTINGS_SECTION } from "../registry";
import type { AppshotSelectValue, AppshotSettingsModel } from "./useAppshotSettingsModel";

/** Thin host adapter: i18n Trans + MacKeyboardPreview; Select is @astravia/ui inside theme-ui. */
