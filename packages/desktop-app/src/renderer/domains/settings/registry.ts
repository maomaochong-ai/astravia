...
export const SETTINGS_TABS: readonly SettingsTabRegistration[] = [
	...
	},
	{
		key: "database",
		label: "数据库",
		labelKey: "tabDatabase",
		icon: "icon-[mdi--database-cog-outline]",
	},
	{ key: "pet", label: "Astravia Vivi", labelKey: "tabPet", icon: "icon-[mdi--paw-outline]" },
	{
		key: "permissions",
		label: "权限管理",
...
export const SETTINGS_SECTIONS = [
	...
	{ tab: "database", id: "database-connections", title: "连接管理", titleKey: "section_database-connections" },
