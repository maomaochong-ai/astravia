...
export function NewSessionPageView({
	...
	return (
		<div className="flex h-full min-w-0 flex-1 gap-2 overflow-visible">
			...
			/>
			{/* 新建会话页与聊天页一致：活动面板常驻挂载，顶栏「活动面板」按钮切换其开合。
			    cwd 用路由参数（activeSession 在新建会话页被清空），保证 tab 记忆与数据库标签可用。 */}
