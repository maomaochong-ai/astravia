...
import type { FilePreviewItem, PreviewBodyViewProps } from "@astravia/theme-ui/file-preview";
import { getExtension } from "@astravia/theme-ui/file-preview";
...
async function loadItem(
	...
	if (item.path) {
		return await window.astravia.fs.readFile(item.path);
	}
	if (!item.url) {
