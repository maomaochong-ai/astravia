...
/**
 * 视图 id 直接进 URL 段，且会作为侧边栏导航 key 的一部分，故只允许保守字符集：
 * 首字符字母数字，后续可含 `.`、`_`、`-`。
 */
export const WORKSPACE_VIEW_ID_PATTERN = /^[a-zA-Z0-9][a-zA-Z0-9._-]*$/;
