		...
		first = requestAnimationFrame(() => {
			void document.fonts.ready.then(() => {
				...
				last = requestAnimationFrame(() => {
					...
					(window as { __astdPainted?: string | null }).__astdPainted = frameId;
...
type EngineRootContainer = HTMLElement & { __astdRoot?: Root };

const container = document.getElementById("root") as EngineRootContainer | null;
if (!container) throw new Error("engine root missing");
const root = container.__astdRoot ?? createRoot(container);
container.__astdRoot = root;
