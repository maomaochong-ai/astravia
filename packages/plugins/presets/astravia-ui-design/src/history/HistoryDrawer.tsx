...
export function HistoryDrawer({ session, peekSha, onPeek, onRestored, offsetTop, onClose }: HistoryDrawerProps) {
	...
	return (
		<div
			className="astd-note astd-note-surface astd-note-drawer-enter pointer-events-auto absolute z-40 flex flex-col overflow-hidden rounded-xl border border-border/60 bg-popover/95 shadow-xl ring-1 ring-black/5 backdrop-blur-xl"
