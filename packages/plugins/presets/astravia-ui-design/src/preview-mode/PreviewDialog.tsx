...
import { frameUrl, pathOfFrame } from "../astd/frame-url";
...
function sizeOfFrame(frames: readonly AstdFrameEntry[], frameId: string | null): ViewportSize | null {
 ...
 */
export function PreviewDialog({ port, frames, astdPath, initialFrameId, onClose }: PreviewDialogProps) {
