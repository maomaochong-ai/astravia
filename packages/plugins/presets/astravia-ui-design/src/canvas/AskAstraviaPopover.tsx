...
interface AskAstraviaPopoverProps {
	busy: boolean;
...
/**
 * In-canvas input for "让 Astravia 调整": type the adjustment, send straight to
 * Astravia. Anchored above the ask button rather than to a frame — the ask can
 * target several frames (or the whole design), so there is no single anchor.
 */
export function AskAstraviaPopover({ busy, onSend, onClose }: AskAstraviaPopoverProps) {
