...
import type { ParsedFrameMeta } from "../src/astd/frame-meta";
import { FALLBACK_FRAME_SIZE, type FrameSizeInput, resolveFrameSizes } from "../src/astd/frame-size";
import type { FrameMeta, FrameSize } from "../src/astd/manifest-types";
...
it("falls back to the design's declared product size, not the desktop constant", () => {
	...
	// astd_create 现在把品类记在 manifest 里，同样的疏忽落到手机尺寸。
