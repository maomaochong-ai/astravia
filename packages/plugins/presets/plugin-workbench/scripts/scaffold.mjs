#!/usr/bin/env node
/**
 * Scaffold a minimal Astravia MF plugin project under a target directory.
	...
	"package.json": `${JSON.stringify(
		{
			...
			devDependencies: {
				...
				"@astravia-org/plugin-sdk": args.sdk,
				"@astravia-org/plugin-vite": args.vite,
				react: "19.1.1",
				"react-dom": "19.1.1",
				tailwindcss: "^4.1.12",
				typescript: "^5.9.2",
