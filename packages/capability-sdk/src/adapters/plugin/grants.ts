...
function buildOfficialDomainGrants(): CapabilityGrant[] {
	return [
		...
		createCapabilityGrant(DOMAIN_DATABASE_CAPABILITIES.LIST_CONNECTIONS),
		createCapabilityGrant(DOMAIN_DATABASE_CAPABILITIES.ADD_CONNECTION),
		createCapabilityGrant(DOMAIN_DATABASE_CAPABILITIES.TEST_CONNECTION),
		createCapabilityGrant(DOMAIN_DATABASE_CAPABILITIES.REMOVE_CONNECTION),
