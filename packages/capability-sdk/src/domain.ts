...
/** Stable prefix for Astravia-owned domain capabilities. Prefixes are never authorization rules. */
export const ASTRAVIA_DOMAIN_CAPABILITY_PREFIX = CAPABILITY_PREFIXES.ASTRAVIA_DOMAIN;
