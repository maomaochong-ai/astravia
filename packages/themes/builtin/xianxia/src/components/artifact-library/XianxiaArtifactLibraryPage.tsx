import type { ThemePageProps } from "@astravia/theme-sdk";
import { HorizontalSliceImageFrame, NineSliceImageDecoration, NineSliceImageFrame } from "@astravia/theme-ui";
