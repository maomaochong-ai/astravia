...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@astravia/coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@astravia/coding-agent?style=flat-square" /></a>
...
```bash
npm install -g @astravia/coding-agent
```
...
| `ASTRAVIA_TRACING` | Set to `langfuse` to emit agent/LLM/tool observations with prompt, completion, tool input, and tool output content to Langfuse |
| `ASTRAVIA_TRACING_TRACE_NAME` | Optional trace name shown in Langfuse |
...
- [@astravia/ai](https://www.npmjs.com/package/@astravia/ai): Core LLM toolkit
