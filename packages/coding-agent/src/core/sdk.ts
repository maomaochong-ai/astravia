...
import { Agent, type AgentMessage, type ThinkingLevel } from "@astravia/agent-core";
import type { Message, Model } from "@astravia/ai";
...
import { getAgentDir, getAstraviaHomePath, getDocsPath } from "../config.js";
...
export interface CreateAgentSessionOptions {
	...
	/**
	 * Optional platform-neutral tracer. If omitted, ASTRAVIA_TRACING=langfuse enables Langfuse.
	 */
...
export async function createAgentSession(options: CreateAgentSessionOptions = {}): Promise<CreateAgentSessionResult> {
	...
	const session = new AgentSession({
		...
		// Astravia-nested .codex/.claude only; does not read top-level ~/.codex / ~/.claude.
