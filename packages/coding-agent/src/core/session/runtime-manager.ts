...
import type { AgentMessage, AgentTool } from "@astravia/agent-core";
import { resetApiProviders } from "@astravia/ai";
...
export class RuntimeManager {
	...
	buildRuntime(options: {
		...
		if (this._baseToolsOverride) {
			...
			if (process.env.ASTRAVIA_KNOWLEDGE_DISABLED !== "1") capabilities.add("knowledge");
