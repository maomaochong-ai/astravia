...
${chalk.bold(`Available Tools (default: ${defaultToolsList}):`)}
  ...
  extract_text_from_pdf - OCR a PDF (PP-OCRv5, scanned or born-digital) via Astravia Desktop
  extract_text_from_img - OCR a single image (PNG/JPG/WebP/BMP/GIF) via Astravia Desktop
