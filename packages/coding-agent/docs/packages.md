...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@astravia/ai`, `@astravia/agent-core`, `@astravia/coding-agent`, `@mariozechner/pi-tui`, `@sinclair/typebox`.
