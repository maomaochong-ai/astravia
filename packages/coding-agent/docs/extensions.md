...
| Package | Purpose |
|---------|---------|
| `@astravia/coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@astravia/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
...
```typescript
import { isToolCallEventType } from "@astravia/coding-agent";
...
```typescript
import { isBashToolResult } from "@astravia/coding-agent";
...
**Important:** Use `StringEnum` from `@astravia/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@astravia/coding-agent";
...
```typescript
import { createBashTool } from "@astravia/coding-agent";
...
```typescript
import { keyHint } from "@astravia/coding-agent";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@astravia/coding-agent";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@astravia/coding-agent";
