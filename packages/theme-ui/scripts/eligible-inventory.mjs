...
function classify(abs, text, deferrals) {
	...
	// Migration target is @astravia/ui when primitives land, not theme-ui business domains.
	if (/\/shared\/components\/ui\//.test(rel)) {
		return {
			status: "permanent_desktop",
			rel,
			lines,
			reason: "host design-system primitive implementation (chrome); leave until @astravia/ui",
		};
	}
