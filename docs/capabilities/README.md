...
Theme 开发者仍然只使用 `@astravia/theme-sdk` 的 hook 和类型。Theme SDK、renderer host、preload/IPC 是公开 facade 到内部 Theme Adapter 的桥接，不向主题代码暴露 Capability Client、Grant 或内部 Adapter。
