...
3. **触发机制不全（反馈 8）**：dbx 工具调用时未自动上栏（db-panels-tab-layout.md 4.3-B 设计未完整实现）；工作台无「问数」入口（反馈 2）。
...
**关联**：db-panels-tab-layout.md §七阶段 7、rebrand/blueprint.md §十七。
